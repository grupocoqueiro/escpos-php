    ...
    public static function load(
        ...
        foreach ($preferred as $implemetnation) {
            if ($implemetnation === 'imagick') {
                ...
                return new \Saci\Escpos\ImagickEscposImage($filename, $allowOptimisations);
            } elseif ($implemetnation === 'gd') {
                if (!self::isGdLoaded()) {
                    // Skip option if GD not loaded
                    continue;
                }
                return new \Saci\Escpos\GdEscposImage($filename, $allowOptimisations);
                ...
                return new \Saci\Escpos\NativeEscposImage($filename, $allowOptimisations);
            } else {
